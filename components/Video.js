            ...
            <section className="aboutSection px-4  bg-gray-100 my-4 py-12 ">
                <div className="max-w-[1200px] mx-auto p-4 flex flex-col relative">
                    ...
                    <div className="relative overflow-hidden w-full pt-[56.25%] px-4">
                        <iframe className="absolute top-0 left-0 right-0 bottom-0 w-full h-[100%]"   src="https://www.youtube.com/embed/RPF-EsbGrDg" title="YouTube video player"  allow="accelerometer; encrypted-media; gyroscope;" allowFullScreen></iframe>
                    </div>
                    <div className="relative overflow-hidden w-full pt-[56.25%] mt-8 px-4">
                        <iframe className="absolute top-0 left-0 right-0 bottom-0 w-full h-[100%]"   src="https://www.youtube.com/embed/cfiPth_M9vI" title="YouTube video player"  allow="accelerometer; encrypted-media; gyroscope;" allowFullScreen></iframe>
                    </div>

                    <div className="relative overflow-hidden w-full pt-[56.25%] mt-8 px-4">
                        <iframe className="absolute top-0 left-0 right-0 bottom-0 w-full h-[100%]"  src="https://www.youtube.com/embed/i8KTZwwmBcI" title="YouTube video player"  allow="accelerometer; encrypted-media; gyroscope;" allowFullScreen></iframe>
                    </div>
